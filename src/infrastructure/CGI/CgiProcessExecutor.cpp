...
CgiProcessExecutor::~CgiProcessExecutor()
{
    cleanup();
}

bool CgiProcessExecutor::start(const std::string& scriptPath,
...
int CgiProcessExecutor::getReadFd() const
{
    return (_pipeFromChild[0]);
}

int CgiProcessExecutor::getWriteFd() const
{
...
bool CgiProcessExecutor::onWriteReady()
{
    ...
    ssize_t written = write(_pipeToChild[1],
