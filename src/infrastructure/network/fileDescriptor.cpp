...
FileDescriptor::~FileDescriptor() { invalidate(); }

bool FileDescriptor::isValid() const { return (_fd >= 0); }
...
bool FileDescriptor::operator==(const FileDescriptor& other) const { return (_fd == other._fd); }
